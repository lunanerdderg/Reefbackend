...
bool cli() {
    ...
    while (running) {
        ...
        // ------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        else if (command.substr(0,10) == "fileExists") {
        ...
        else if (command.substr(0,19) == "commandDoesNotExist") {
        ...
        else if (command.substr(0,9) == "inProject") {
        ...
        else if (command.substr(0,8) == "copyFile") {
        ...
        else if (command.substr(0,8) == "moveFile") {
            index = readTo(command, '"', 10)-1;
            std::string fileName = command.substr(10, index - 9);
            index2 = readTo(command, '"', index + 4)-1;
            std::string destination = command.substr(index + 4, index2 - index - 3);
        ...
        else if (command.substr(0,10) == "renameFile") {
            index = readTo(command, '"', 12)-1;
        ...
        else if (command.substr(0,13) == "makeDirectory") {
        ...
        else if (command.substr(0,10) == "deleteFile") {
            index = readTo(command, '"', 12)-1;
        ...
        else if (command.substr(0,5) == "unzip") {
        ...
        else if (command.substr(0,21) == "dlLatestGithubRelease") { // dlLatestGithubRelease "SubnauticaModding/Nautilus" "Nautilus_SN.STABLE_.zip" "$HOME/Documents/Programming/C++/Reefbackend/.templates MEGA_EXCLUDED/test" 1 1 "-pre"
            ...
            if (dlBepInEx(location)) {
                std::cout << "\nBepInEx successfully downloaded. Now open Subnautica, then quit from main menu to install!\n";
            }
            else {
        ...
        else if (command.substr(0,12) == "addToLibrary") { // addToLibrary "/home/luna/Documents/BYOND/cfg.zip"
        ...
        else if (command.substr(0,14) == "addToLibraryGh") {
            index = readTo(command, '"', 16)-1;
        ...
        else if (command.substr(0,20) == "changeSavesDirectory") {
